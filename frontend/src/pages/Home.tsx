      ...
      <div className="relative pt-16">
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl shadow-2xl p-10 md:p-12 text-center text-white"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
            >
              ...
              <p className="text-emerald-50 text-lg mb-8 max-w-2xl mx-auto">
                Join hundreds of successful startups who trusted StartupHealer to guide them from idea to impact.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <motion.a
                  href="/services"
                  className="inline-block bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-emerald-600 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Explore Services
