    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-gray-800">
          Meet the <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">Team</span>
        </h2>
      ...
      >
        {teamMembers.map((member, idx) => (
          <motion.div
            ...
            whileHover={{ y: -8 }}
          >
            <div className="flex flex-col items-center rounded-2xl p-8 shadow-lg bg-white/95 backdrop-blur-md border-2 border-emerald-200 hover:border-emerald-400 hover:shadow-2xl transition-all duration-300 h-full">
              {/* Avatar */}
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-opacity"></div>
                <img
                  src={member.img}
                  alt={member.name}
                  className="relative h-28 w-28 rounded-full border-4 border-emerald-500 object-cover bg-white shadow-xl group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-4">
                {member.expertise.map((skill, skillIdx) => (
                  <span
                    key={skillIdx}
                    className="bg-emerald-100 text-emerald-700 text-xs font-medium px-3 py-1 rounded-full border border-emerald-200"
                  >
                    {skill}
                  </span>
                ))}
              ...
              {/* Social Links */}
              <div className="flex gap-3 mt-auto pt-4 border-t border-emerald-100 w-full justify-center">
                <motion.a
                  href="#"
                  className="w-10 h-10 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-full flex items-center justify-center text-emerald-600 hover:from-emerald-500 hover:to-teal-500 hover:text-white transition-all duration-300 shadow-md"
      ...
      {/* Bottom CTA */}
      <motion.div
        className="mt-16 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border-2 border-emerald-200"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
