    ...
    <footer className="bg-white border-t-2 border-cyan-200 text-gray-800">
      <div className="py-12 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            At StartupHealer, we empower entrepreneurs with the right tools and
            guidance to launch, grow, and scale their businesses. From
            registrations and certifications to funding, branding, and digital
            growth — we are your trusted startup partner.
          </p>
          <div className="flex space-x-4">
            <a
              href="https://www.facebook.com/share/1YihEGHF8S/"
              aria-label="Facebook"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/startuphealer?utm_source=qr&igsh=MTM0bHR3bm1iZ3h3eg=="
            ...
            <a
              href="https://www.linkedin.com/in/startup-healer-7773b2377?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              aria-label="LinkedIn"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div>
          ...
          <div className="flex items-center mb-4 space-x-3 text-gray-600">
            ...
            <a
              href="mailto:sales@startuphealer.com"
              className="hover:text-cyan-600 transition-colors font-medium"
            >
          ...
          <div className="flex items-start space-x-3 text-gray-600">
            ...
            <address className="not-italic leading-relaxed">
              P NO 8, near VPM Classes, B yojna, Radha Kunj, Mansarovar, Jaipur,
              Rajasthan 302020
            </address>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-cyan-50 via-emerald-50 to-green-50 text-center py-4 border-t border-cyan-200">
        <p className="text-sm text-gray-600">
          ...
          <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-emerald-600">
            StartupHealer
          </span>
          . All rights reserved.
        </p>
